...
**• User intent framing**: cross-pollination feed or polymathic feed — built for someone whose taste spans disciplines, where the value is in the collision of unrelated domains rather than a filtered single-interest stream.
