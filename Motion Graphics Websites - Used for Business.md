...
project:
  ...
  - "[[Jay Steel]]"
  - "[[Steelspeaks]]"
topic: Motion Graphics applied to content
type: dump
created:
  "{ date }":
review_date:
...
* **Malloy.sg**: https://portal.malloy.sg/

Websites like this can be used to enhance or fully make content for our various brands...
