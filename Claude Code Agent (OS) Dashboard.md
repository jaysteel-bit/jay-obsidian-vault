...
project:
  - "[[Exo]]"
topic: Agent OS System via Claude Code, etcs.
type: dump
created:
  "{ date }":
review_date:
...
https://youtube.com/watch?v=Bgxsx8slDEA&si=8d2-NGEXUf69Ay5S — 
...
### <u>Transcript (May contain errors/typos)</u>

*Video Title: ==**”Stop Using Claude Code Without An Agentic OS” by @Chase-A-AI**==*
